...
public class GroupMemberManagerAdapter extends BaseAdapter {
    ...
    private GroupMemberManagerLayout.OnItemClickListener onItemClickListener;

    public void setOnItemClickListener(GroupMemberManagerLayout.OnItemClickListener onItemClickListener){
        ...
        if (view == null) {
            ...
            holder.memberIcon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    onItemClickListener.onGroupMemberClick(view, i, mGroupInfo);
                }
            });
