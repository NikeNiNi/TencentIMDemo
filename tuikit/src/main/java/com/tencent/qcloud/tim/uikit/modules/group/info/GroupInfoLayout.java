...
public class GroupInfoLayout extends LinearLayout implements IGroupMemberLayout, View.OnClickListener {
    ...
    private LineControllerView mMsgAllMuteView;
    ...
    private void init() {
        ...
        mMsgAllMuteView = findViewById(R.id.msg_all_mute);
        mMsgAllMuteView.setCheckListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                ...
                Log.d("yp----->",isChecked+";"+mGroupInfo.getIsAllMute());
                if (isChecked == mGroupInfo.getIsAllMute()){
                    return;
                }
                ...
                V2TIMManager.getGroupManager().setGroupInfo(v2TIMGroupInfo, new V2TIMCallback() {
                    @Override
                    public void onSuccess() {
                        ToastUtil.toastLongMessage(mGroupInfo.getGroupType()+ ": 全员禁言");
                        mMsgAllMuteView.setChecked(true);
                    }

                    @Override
                    public void onError(int code, String desc) {
                        mMsgAllMuteView.setChecked(false);
                        ToastUtil.toastLongMessage("code: "+code +";Message: "+desc);
                    }
                });
            }
        });
    ...
    private void setGroupInfo(GroupInfo info) {
        ...
        mMsgAllMuteView.setChecked(mGroupInfo.getIsAllMute());
